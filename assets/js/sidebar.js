...
(function () {
  ...
  const MODULE_CONFIG = {
    ...
    "budget_monitor": { label: "Budget Monitor", href: "budget_monitor.html", order: 3 },
    "pipeline": { label: "Pipeline Manager", href: "pipeline.html", order: 4 },
    "projects": { label: "Projects", href: "projects.html", order: 5 },
    "vendors": { label: "Vendors", href: "vendors.html", order: 6 },
    "accounts": { label: "Accounts", href: "accounts.html", order: 7 },
    "estimator": { label: "Estimator Suite", href: "estimator.html", order: 8 },
    "team": { label: "Team Management", href: "team.html", order: 9 },
    "messages": { label: "Messages", href: "messages.html", order: 10 },
    "arturito": { label: "Arturito", href: "arturito.html", order: 11 },
    "god_view": { label: "God View", href: "god-view.html", order: 12 },
    "reporting": { label: "Reporting", href: "reporting.html", order: 13 },
    "budgets": { label: "Budgets", href: "budgets.html", order: 14 },
    "roles": { label: "Roles Management", href: "roles.html", order: 15 },
    "settings": { label: "Settings", href: "settings.html", order: 16 },
    "audit": { label: "Audit Logs", href: "audit.html", order: 17 },
  };
